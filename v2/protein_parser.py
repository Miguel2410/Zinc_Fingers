...
"""This script parse all the proteins in the directory that you pass it, and return them as instances inside a list.
   If executed as main, it will take the first parameter as the folder to search for proteins. """
...
def parse_proteins(directory):
    ...
    for file in os.listdir(directory):
        ...
        if file.endswith(".pdb") or file.endswith(".ent") or file.endswith(".cif"):
            ...
            proteins.append((prot.name, prot))

    return proteins

if __name__ == "__main__":
    print(parse_proteins(sys.argv[1]))